  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用戶','{{url('admin/user/create')}}',600,400)"><i class="layui-icon"></i>添加</button>
        <span class="x-right" style="line-height:40px">共有數據：88 條</span>
      </xblock>
        ...
        <tbody>
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="編輯"  onclick="x_admin_show('編輯','member-edit.html',600,400)" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a onclick="x_admin_show('修改密碼','member-password.html',600,400)" title="修改密碼" href="javascript:;">
                <i class="layui-icon">&#xe631;</i>
              </a>
